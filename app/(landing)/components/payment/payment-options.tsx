...
const paymentList = [
  {
    bank_name: "BCA",
    account_number: 16866879,
    account_holder: "PT SPortOn Digital",
  },
  {
    bank_name: "Mandiri",
    account_number: 9768868979,
    account_holder: "PT SPortOn Digital",
  },
  {
    bank_name: "BRI",
    account_number: 755199111,
    account_holder: "PT SPortOn Digital",
  },
];
      ...
      {paymentList.map((payment, index) => (
        <div className="flex gap-5 p-5 border-b border-gray-100" key={index}>
          ...
          <div className="self-center">
            ...
            <div className="text-xs">{payment.account_number}</div>
            <div className="text-xs opacity-70">{payment.account_holder}</div>
          </div>
