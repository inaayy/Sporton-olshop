...
const BankInfoModal = ({ isOpen, onClose, bank, onSuccess }: TBankInfoModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onSuccess?.();
      onClose();
      toast.success(isEditMode ? "Bank update successfully!" : "Bank info created successfully!");
    } catch (error) {
      console.error(isEditMode ? "Failed to update info bank" : "Failed to create bank info", error);
        ...
        <div className="flex flex-col gap-4 w-full">
          <div className="input-group-admin">
            ...
            <input
              ...
              id="bankName"
              name="bankName"
              placeholder="e. g. Madiri, BCA, BRI"
