    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Verify Transaction">
      <div className="flex gap-6">
        <div>
          ...
          <Image src="/images/payment-proof.png" alt="payment proof" width={200} height={401} />
        </div>
        <div>
          ...
          <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-4 text-sm mb-5">
            <div className="flex justify-between font-medium">
              ...
              <div className="text-right">20/01/2026 18:25</div>
            </div>
            <div className="flex justify-between font-medium">
            ...
            <div className="flex justify-between font-medium">
              ...
              <div className="text-right">+62859106821</div>
            </div>
            <div className="flex justify-between gap-10 font-mediu">
              <div className="opacity-50 whitescape-nowrap">Shipping Address</div>
          ...
          <div className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
            <div className="bg-gray-100 rounded aspect-square w-8 h-8">
              <Image src="/images/products/basketball.svg" width={30} height={30} alt="product image" />
            </div>
          ...
          <div className="flex justify-end gap-5 mt-12">
            <Button className="text-primary! bg-[#FF5F3F33]! rounded-md" size="small">
              <FiX size={20} />
              Reject
            </Button>
