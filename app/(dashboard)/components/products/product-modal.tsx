...
const ProductModal = ({ isOpen, onClose, onSuccess, product }: TProductModalProps) => {
  ...
  const handleChangae = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(isEditMode ? " Product updates successfully!" : "roduct created successfully!");
    ...
    <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit Product" : "Add New Product"}>
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        <div className="flex gap-7">
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <div className="input-gorup-admin">
              ...
              <select name="categoryId" id="categoryId" value={formData.categoryId} onChange={handleChangae}>
        ...
        <div className="input-group-admin">
          ...
          <textarea name="description" id="description" rows={7} placeholder="Product Details..." value={formData.description} onChange={handleChangae}></textarea>
        </div>
